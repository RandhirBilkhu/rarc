...
The example below shows a subset of a cedant's data where there are two insureds, "berlin" and "frankfurt" which have been written in 2019 and renewed in 2020. The names vary slightly from year to year.
...
It is now easy to summarise the detailed output by whatever segmentation is required - show below by policy period
